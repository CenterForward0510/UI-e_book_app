...
Color blackColor2 = Color(0xFF00000);
Color greyColor = Color(0xBFFBDBDBD);
...
TextStyle regularText112 = GoogleFonts.poppins(fontSize: 12, fontWeight: regular, color: greyColor);

TextStyle mediumText10 = GoogleFonts.poppins(fontSize: 10, fontWeight: regular);
TextStyle mediumText12 = GoogleFonts.poppins(fontSize: 12, fontWeight: regular, color: dividerColor);
TextStyle mediumText14 = GoogleFonts.poppins(fontSize: 14, fontWeight: regular);
TextStyle mediumText16 = GoogleFonts.poppins(fontSize: 16, fontWeight: regular);
